...
\inferrule{Γ : e ⇓_ρ Δ;Ψ : λy.e' \\  Δ : e'[x/y] ⇓_{qρ} Θ;Ξ : z}
           {Γ : e_q x ⇓_ρ Θ;Ξ : z} \text{application}

\inferrule{Γ : e  ⇓_ω  Δ : z}{(Γ,x ↦_ω e) : x ⇓_ρ (Δ;x ↦_ω z) : z}\text{unrestricted variable}
...
\inferrule{Γ: e ⇓_ρ Δ,Ψ: c_k  x₁ … x_n \\   Δ :  e_k[xᵢ/yᵢ] ⇓_ρ Θ :  z}
