...
% Temporarily switch to the good old format while writing:
\documentclass[sigplan,9pt,dvipsnames]{acmart}\settopmatter{printfolios=true}
...
and we retain same safety guarantees as on-heap data.
%
