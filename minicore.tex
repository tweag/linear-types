...
once if $π=1$ and without any restriction if $π=ω$). This $π$ is the
subscript in $⊢_π$ in the alternative typing judgement.
...
times we use $z$.\improvement{We may try and make this argument
