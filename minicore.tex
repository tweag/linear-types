...
\newcommand{\caserule}{\inferrule{Γ   ⊢  t  : D~π_1~…~π_n \\
      \text{$Δ ⊢_π c_k  x₁ … x_{n_k} → u_k : C$ for each $1 ⩽ k ⩽ m$}}
...
\begin{figure}
  \begin{mathpar}
    ...
    {ωΓ+\sum_i μ_i[π₁…π_n]Δ_i ⊢ c  t₁ … t_n : D~π₁~…~π_n}\text{con}
    ...
    \inferrule{
      ...
      Δ, z:_{ν} D π_1…π_n, x₁:_{ρ_1} A_i, …, x_{n}:_{ρ_{n}} A_{n} ⊢ u : C \\
      ρ_1+νμ_1[π_1…π_r]=πμ_1[π_1…π_r]\quad…\quad ρ_{n}+νμ_{n}[π_1…π_r]=πμ_{n}[π_1…π_r]
    }{Γ ⊢_π c  x₁ … x_{n} → u : C}
  \end{mathpar}
