...
\begin{figure}
  ...
  In the case rule: the scrutinee comes with multiplicity $π$, and thus each $x$ has to be used with multiplicity $πμ$. But; each use of the scrutinee variable causes $νμ$ usages $x$. Thus, the constraint $ρ+νμ=πμ$.
