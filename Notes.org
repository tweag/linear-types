...
And prove if Ξ ⊢ let γ in t : A then Ξ ⊢ let δ in z : A.
Consistency of the heap is in turn guaranteed by the typesystem.
...
------------------------------------------------------------- shared variable
  ρΞ ⊢ (let Γ,x :ω B = e in x  ⇓ let Δ, x :ω B = z in z)
...
---------------------------------------------------- let
  ...
  qρΞ ⊢ (let Γ in e ⇓ let Δ in c x) : D
  ρΞ ⊢ (let Δ in u[x/y] ⇓ let θ in z) : C
---------------------------------------------------------------- case
  ρΞ ⊢ (let Γ in case[q] e of {c y ↦ u } ⇓ let θ in z) : C


  ρΞ ⊢ (let Γ in e ⇓ let Δ in Bang x) : Bang A
  ρΞ ⊢ (let Δ in u[x/y] ⇓ let θ in z) : C
---------------------------------------------------------------- case
  ρΞ ⊢ (let Γ in case[q] e of {Bang y ↦ u } ⇓ let θ in z) : C
